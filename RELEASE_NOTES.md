...
- Bổ sung GIF tự host `assets/gtmt-data-flow.gif` để mô phỏng đường dữ liệu AHT20 → BLE SoC → UART/VCOM → SQLite.
...
| `ThucHanhGTMT-source-v1.2.0.zip` | Source snapshot từ commit phát hành |
