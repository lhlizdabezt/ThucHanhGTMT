...
This update keeps `ThucHanhGTMT` aligned with the English-facing engineering portfolio while removing dash-line motion from SVG visuals.

## Changes

- Cleaned `assets/gtmt-motion.svg` so SVG motion no longer uses moving dashed or dotted line effects.
